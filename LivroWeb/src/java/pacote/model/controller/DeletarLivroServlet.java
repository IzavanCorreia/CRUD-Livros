...
public class DeletarLivroServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet DeletarLivroServlet</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Livro deletado com exito do sistema!</h1>");
            out.println("<a href='ApresentaLivrosServlet'>Menu de livros</a>");
            out.println("</body>");
            out.println("</html>");
        }
    }
